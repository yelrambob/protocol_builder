...
- A **sidebar**, collapsed to a 56px icon rail by default. Hovering it just widens the rail so labels are readable; every drill-down level below only opens on **click** (hovering to auto-open nested menus got cumbersome once there were several levels), and drills down three levels, each starting collapsed until you click it open:
