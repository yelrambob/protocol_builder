 ...
 * GE convention, overridable per site via plane-labels.json), and the reading category a body
 * part belongs to (keyword-guessed - Neuro/Body/MSK/Other - overridable per exact body part
 * string via category-labels.json).
