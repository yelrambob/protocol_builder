...
/**
 * Usage: Main <input> [--json <dir>] [--html <file>] [--book-title <text>] [--peds-weights <file>] [--overrides <file>]
 ...
 * welcome-page heading (defaults to "Protocol Book"); --pdf-library entries are linked (title+url
    ...
    public static void main(String[] args) {
        try {
            ...
            if (htmlFile != null) {
                ...
                new ProtocolBookHtmlWriter().write(protocols, overrides, labels, logoDataUri, pdfLibrary, protocolImages, bookTitle, htmlFile);
